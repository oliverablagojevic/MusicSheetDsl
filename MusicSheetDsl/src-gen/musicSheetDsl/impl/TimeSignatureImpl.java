 ...
 * </p>
 * <ul>
 *   <li>{@link musicSheetDsl.impl.TimeSignatureImpl#getBeat <em>Beat</em>}</li>
 *   <li>{@link musicSheetDsl.impl.TimeSignatureImpl#getBeatType <em>Beat Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeSignatureImpl extends MinimalEObjectImpl.Container implements TimeSignature {
	...
	protected EClass eStaticClass() {
		return MusicSheetDslPackage.Literals.TIME_SIGNATURE;
	}
	...
	public void setBeat(int newBeat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MusicSheetDslPackage.TIME_SIGNATURE__BEAT, oldBeat,
					beat));
	}
	...
	public void setBeatType(int newBeatType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MusicSheetDslPackage.TIME_SIGNATURE__BEAT_TYPE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MusicSheetDslPackage.TIME_SIGNATURE__BEAT:
			return getBeat();
		case MusicSheetDslPackage.TIME_SIGNATURE__BEAT_TYPE:
			return getBeatType();
		}
