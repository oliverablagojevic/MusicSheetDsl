...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Note Duration</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see musicSheetDsl.MusicSheetDslPackage#getNoteDuration()
 * @model
 * @generated
 */
public enum NoteDuration implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Note Duration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NoteDuration[] VALUES_ARRAY = new NoteDuration[] { WHOLE, HALF, QUARTER, EIGHTH, SIXTEENTH,
			THIRTYSECOND, SIXTYFOURTH, };

	/**
	 * A public read-only list of all the '<em><b>Note Duration</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NoteDuration> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Note Duration</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NoteDuration get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NoteDuration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Note Duration</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static NoteDuration getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NoteDuration result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Note Duration</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NoteDuration get(int value) {
		switch (value) {
		case WHOLE_VALUE:
			return WHOLE;
		case HALF_VALUE:
	 ...
	 * @generated
	 */
	private NoteDuration(int value, String name, String literal) {
		this.value = value;
		this.name = name;
